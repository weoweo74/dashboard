...
ui <- dashboardPage(
    ...
    dashboardSidebar(
        sidebarMenu(
            ...
            menuItem("SAMENVATTING", tabName = "samenvatting"), 
            menuItem("TIJDSANALYSE", tabName = "tijdsanalyse"),
    ...
    dashboardBody(
        tabItems(
            ...
            tabItem(        # Output page 2
                tabName = "tijdsanalyse",
                fluidRow(
                    column(
                        width = 10,
                        offset = 2, 
            ...
            tabItem(        # Output page 5
                tabName = "opdrachtgevers", 
                fluidRow(
                    column(
                        width = 2, offset = 2, 
            ...
            tabItem(        # Output page 6
                tabName = "statistieken", 
                fluidRow(
                    column(
                        width = 4, 
                        offset = 2, 
                ...
                fluidRow(
                    column(
                        width = 12, 
                        box(width = 7, plotlyOutput(outputId = "plot8")),
                        box(
                            width = 5,
                            fluidRow(
                                column(
